...
# Provided by AMEX via Kaggle. Please see https://www.kaggle.com/code/inversion/amex-competition-metric-python
...
def amex_metric_numpy(y_true: np.array, y_pred: np.array):
